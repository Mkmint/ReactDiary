...
export const emotioinList = [
    {id : 1, name : "😄", img:getEmotionImgById(1)},
    {id : 2, name : "😊", img:getEmotionImgById(2)},
    {id : 3, name : "😐", img:getEmotionImgById(3)},
    {id : 4, name : "😔", img:getEmotionImgById(4)},
    {id : 5, name : "💀", img:getEmotionImgById(5)},
]
